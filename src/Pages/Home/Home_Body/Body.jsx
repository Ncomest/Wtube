...
import ButtonLooking from "../../../UI/components/Buttons/ButtonLooking/ButtonLooking";
      ...
      <div ref={containerRef} className="Body_Container">
        <div className="section-header">
          ...
          <Link className="Router-link" to={`/moviescategory/upcoming`}>
            <ButtonLooking text={t("lookingAll")} onClick={handleUp} />
          </Link>
        </div>
        ...
        <div className="section-header">
          ...
          <Link className="Router-link" to={`/moviescategory/popular`}>
            <ButtonLooking onClick={handleUp} text={t("lookingAll")} />
          </Link>
        </div>
